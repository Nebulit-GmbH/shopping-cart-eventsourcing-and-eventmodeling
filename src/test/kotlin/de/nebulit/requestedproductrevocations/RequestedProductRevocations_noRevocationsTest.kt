...
class RequestedProductRevocations_noRevocationsTest {
    ...
    @Test
    fun `RequestedProductRevocations_noRevocationsTest`(scenario: Scenario) {
        ...
        whenResult.andWaitForStateChange {
            ...
            assertThat(readModel.productRevocations).isEmpty()
        }
    }
    ...
    companion object {
        var AGGREGATE_ID = UUID.fromString("5bfe77ea-44e6-4908-9b73-7a79f6371ebb")
    }
